...
namespace exa1try2.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(DbexamenContext context)
        {
            _context = context;
        }
        ...
        {
            var proveedores = from Suppliers in _context.Suppliers select Suppliers;

            if (!String.IsNullOrEmpty(stringBusqueda))
            {
                proveedores = proveedores.Where(c => c.CompanyName!.Contains(stringBusqueda));
            }
